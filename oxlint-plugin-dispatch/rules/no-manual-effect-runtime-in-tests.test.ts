...
const rule = createOxlintRuleHarness("dispatch/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("dispatch/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("dispatch/no-manual-effect-runtime-in-tests");
...
const legacyRule = createOxlintRuleHarness("dispatch/no-manual-effect-runtime-in-tests", {
  filename: "legacy.test.ts",
  ruleOptions: [{ maxOccurrences: 2 }],
});

describe("dispatch/no-manual-effect-runtime-in-tests with maxOccurrences", () => {
  legacyRule.valid(
