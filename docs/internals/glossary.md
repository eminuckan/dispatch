...
Terms whose meaning matters across Dispatch. Architecture and lifecycle constraints belong in the
...
| Dispatch home  | The base data directory. Runtime state normally lives under its `userdata` directory.             |
...
| Term                | Meaning                                                                                                      |
| ------------------- | ------------------------------------------------------------------------------------------------------------ |
| Provider            | The agent runtime Dispatch controls, such as Codex or Claude Code.                                           |
...
| Adapter             | The boundary translating a provider's native protocol into Dispatch operations and events.                   |
