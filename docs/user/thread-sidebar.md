...
When you change a new thread's project, Dispatch stays in the current environment
...
If dragging is unavailable for one environment, update the Dispatch server running in that
