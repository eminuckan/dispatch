...
have no commits beyond the default branch. Only Dispatch-managed worktrees are eligible. Active
...
Dispatch only pulls when it can fast-forward and the checkout has no changed files, untracked files,
