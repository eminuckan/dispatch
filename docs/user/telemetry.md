...
The Dispatch server sends product usage events to PostHog, associated with a hashed account or
...
To disable collection, set `DISPATCH_TELEMETRY_ENABLED=false` in the server's environment before
