...
Both instances must use the same **CODEX_HOME path**. Dispatch prepares the shared
...
Choose the other account from the thread's model picker. Dispatch offers compatible
