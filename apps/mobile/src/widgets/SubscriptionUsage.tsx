...
function SubscriptionUsage(
  ...
  const providers = props.providers ?? [
    { name: "Codex", detail: "Open Dispatch to connect", windows: [], expiresAt: 0 },
    { name: "Claude", detail: "Open Dispatch to connect", windows: [], expiresAt: 0 },
  ];
