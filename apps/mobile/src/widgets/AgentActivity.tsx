...
export function AgentActivity(
  ...
  const deepLink =
    deepLinkRow && deepLinkRow.deepLink.startsWith("/") && !deepLinkRow.deepLink.startsWith("//")
      ? `dispatch://${deepLinkRow.deepLink.slice(1)}`
      : null;
  ...
  // The branded Dispatch mark. `assetName` resolves the template image set bundled in
