import type { ArchivedSnapshotEntry } from "@dispatch/client-runtime/state/threads";
import type { OrchestrationProjectShell, OrchestrationThreadShell } from "@dispatch/contracts";
