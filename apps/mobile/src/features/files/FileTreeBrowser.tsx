import type { ProjectEntry } from "@dispatch/contracts";
    ...
    >
      ...
      <Text
        className={cn(
          ...
          props.selected
            ? "font-dispatch-bold text-foreground"
            : node.ignored
              ? "font-dispatch-medium text-foreground-tertiary"
              : "font-dispatch-medium text-foreground-secondary",
        )}
        numberOfLines={1}
      >
        {node.name}
      ...
      {node.kind === "directory" && props.loaded ? (
        <Text className="text-2xs font-dispatch-medium text-foreground-tertiary">
    ...
    <FlatList
      ...
      ListEmptyComponent={
        <View className="px-4 py-5">
          {props.error && props.entries.length === 0 ? (
            <>
              <Text className="text-sm font-dispatch-bold text-foreground">Files unavailable</Text>
              <Text
            ...
            <>
              <Text className="text-sm font-dispatch-bold text-foreground">No files found</Text>
