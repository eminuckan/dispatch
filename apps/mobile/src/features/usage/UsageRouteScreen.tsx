...
import { EnvironmentId, USAGE_CONTRACT_VERSION } from "@dispatch/contracts";
  ...
  return (
    <View className="gap-4 rounded-[24px] border-continuous bg-card p-4">
      <View className="gap-0.5">
        ...
        <Text className="text-4xl font-dispatch-bold tabular-nums text-foreground">
...
function MetricCell(props: {
  ...
  return (
    <View className="w-1/2 gap-0.5 p-4">
      ...
      <Text className="text-xl font-dispatch-medium tabular-nums text-foreground">
        {props.value}
      </Text>
