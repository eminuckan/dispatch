import { type KnownTerminalSession } from "@dispatch/client-runtime/state/terminal";
import { DEFAULT_TERMINAL_ID, type ProjectScript } from "@dispatch/contracts";
import { nextTerminalId, resolveTerminalSessionLabel } from "@dispatch/shared/terminalLabels";
