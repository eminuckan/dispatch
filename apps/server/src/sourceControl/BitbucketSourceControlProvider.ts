...
import { SourceControlProviderError, type ChangeRequest } from "@dispatch/contracts";
...
export const makeDiscovery = Effect.gen(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set DISPATCH_BITBUCKET_EMAIL and DISPATCH_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request, repository, and user read scopes).",
