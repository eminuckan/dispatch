...
import type { VcsDriverKind, VcsError, VcsRepositoryIdentity } from "@dispatch/contracts";
import { VcsUnsupportedOperationError } from "@dispatch/contracts";
...
>()("dispatch/vcs/VcsDriverRegistry") {}
