...
import { parseCliArgs } from "@dispatch/shared/cliArgs";
...
} from "@dispatch/shared/claudeCompaction";
import { HostProcessIsExecutable } from "@dispatch/shared/hostProcess";
  ...
  const startSession: ClaudeAdapterShape["startSession"] = Effect.fn("startSession")(
    function* (input) {
      ...
      const handleResumeDialog = Effect.fn("handleResumeDialog")(function* (
        ...
        // The question copy lives in @dispatch/shared/claudeCompaction because
