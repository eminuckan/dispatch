...
import { T3_PROJECT_FILE_NAME, type T3ProjectFile } from "@dispatch/contracts";
import { T3ProjectFileFromJson } from "@dispatch/shared/t3ProjectFile";
...
>()("dispatch/project/T3ProjectFileLoader") {}
