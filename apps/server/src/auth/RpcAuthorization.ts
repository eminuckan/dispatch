...
export const RPC_REQUIRED_SCOPES = {
  "flow.forThread": AuthOrchestrationReadScope,
  "flow.stop": AuthOrchestrationOperateScope,
  "team.start": AuthOrchestrationOperateScope,
  "team.route": AuthOrchestrationOperateScope,
  "team.control": AuthOrchestrationOperateScope,
  "team.forThread": AuthOrchestrationReadScope,
  "team.get": AuthOrchestrationReadScope,
  ...
  "team.setSmartRoutingSession": AuthOrchestrationOperateScope,
  "team.recommendModels": AuthOrchestrationOperateScope,
  "team.providerDecision": AuthOrchestrationOperateScope,
