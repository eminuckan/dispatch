...
declare const __DISPATCH_BUILD_CHANNEL__: "nightly" | "latest" | undefined;

function resolveLoopbackAuthorizationStage(): LoopbackAuthorizationStage {
  return typeof __DISPATCH_BUILD_CHANNEL__ === "undefined" ? "dev" : __DISPATCH_BUILD_CHANNEL__;
}

const stageBrands = {
  dev: "Dispatch (Dev)",
  nightly: "Dispatch (Nightly)",
  latest: "Dispatch",
