 ...
 * Node or npm on the machine; the `t3` npm package remains a compatibility
 * launcher for legacy installs, and service setup still pins an archive before
 * switching to the standalone runtime.
 */
