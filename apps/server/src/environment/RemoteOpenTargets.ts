 ...
 */
import { type RemoteOpenTarget } from "@dispatch/contracts";
import { HostProcessHostname } from "@dispatch/shared/hostProcess";
import * as NetService from "@dispatch/shared/Net";
import { readTailscaleStatus } from "@dispatch/tailscale";
...
>()("dispatch/environment/RemoteOpenTargets") {}
