...
import { resolveEditorCommand } from "@dispatch/shared/editor";
...
// per-command cache lookups in @dispatch/shared/shell.
//
...
// command-resolution cache in @dispatch/shared/shell, so a backward wall-clock
...
>()("dispatch/process/externalLauncher") {}
