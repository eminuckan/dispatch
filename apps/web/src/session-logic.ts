...
} from "@dispatch/client-runtime/pending-requests";
import { UserInputAttachmentAnswerPayload } from "@dispatch/contracts";
import { foldUserInputActivities } from "@dispatch/client-runtime/work-log/user-input";
import * as Option from "effect/Option";
import * as Schema from "effect/Schema";
import * as Arr from "effect/Array";
import { shallow } from "zustand/vanilla/shallow";
import { isBackgroundTaskActivity } from "@dispatch/client-runtime/state/subagentRuntime";
import {
...
import { extractToolActivityPresentation } from "@dispatch/client-runtime/work-log/tool-presentation";
import {
...
export type { PendingApproval, PendingUserInput } from "@dispatch/client-runtime/pending-requests";

export { formatDuration } from "@dispatch/shared/orchestrationTiming";
...
export interface WorkLogEntry {
  ...
  toolTitle?: string;
  toolSurface?: import("@dispatch/contracts").ToolActivitySurface;
  toolIcon?: import("@dispatch/contracts").ToolActivityIcon;
  toolSource?: import("@dispatch/contracts").ToolActivitySource;
  toolData?: unknown;
