...
export const CUSTOM_THEMES_STORAGE_KEY = "dispatch:themes:v1";
export const THEME_FOLLOW_SYSTEM_STORAGE_KEY = "dispatch:theme-follow-system";
export const THEME_APPEARANCE_MODE_STORAGE_KEY = "dispatch:theme-appearance-mode";
export const THEME_HALVES_STORAGE_KEY = "dispatch:theme-halves:v1";
...
function readCustomThemeLibrarySnapshot(): CustomThemeLibrarySnapshot {
  ...
  let raw: string | null;
  try {
    raw = readMigratedStorageItem(window.localStorage, CUSTOM_THEMES_STORAGE_KEY);
  } catch (cause) {
...
/**
 * The status colors Dispatch shows without a theme, read from the app's own
