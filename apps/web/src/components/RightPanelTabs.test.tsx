import { EnvironmentId, type ThreadPullRequestLink } from "@dispatch/contracts";
import type { DesktopPreviewFavicon, PreviewSessionSnapshot } from "@dispatch/contracts";
