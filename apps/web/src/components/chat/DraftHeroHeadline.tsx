...
import { resolveEnvironmentMachineKind, type ScopedProjectRef } from "@dispatch/contracts";
import { scopedProjectKey, scopeProjectRef } from "@dispatch/client-runtime/environment";
