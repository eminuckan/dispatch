...
import {
  ...
  hasQuestionAnswer,
} from "@dispatch/client-runtime/work-log/user-input";
import {
...
import { parseScopedThreadKey } from "@dispatch/client-runtime/environment";
...
import { resolveWorkGroupScrollAnchor } from "@dispatch/client-runtime/work-log/scroll-anchor";
import type {
  AgentPanelModel,
  RuntimeSubagent,
...
import { resolveChatListAnchoredEndSpace } from "@dispatch/shared/chatList";
import { toolActivityFaviconUrl } from "@dispatch/shared/favicon";
import { formatDuration } from "@dispatch/shared/orchestrationTiming";
import { getProjectFaviconCacheKey } from "@dispatch/shared/projectFavicon";
  ...
  return (
    <>
      <div className="relative min-w-0 px-1 py-0.5">
        <MessageAuthorHeading>Dispatch</MessageAuthorHeading>
        <AssistantCitationSource
          messageId={row.message.id}
...
function QuestionAnswerHistory({
  ...
  answer: import("@dispatch/contracts").UserInputAttachmentAnswerPayload;
}) {
  const { activeThreadEnvironmentId } = use(TimelineRowCtx);
