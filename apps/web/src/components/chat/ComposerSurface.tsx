  ...
  return (
    <div
      ...
      className={cn(
        ...
        "dark:[html[data-theme-id]:not([data-theme-id=dispatch-chat])_&]:[--chat-composer-highlight:color-mix(in_srgb,var(--app-theme-input)_12%,transparent)] dark:[html[data-theme-id]:not([data-theme-id=dispatch-chat])_&]:[--chat-composer-outline:color-mix(in_srgb,var(--app-theme-input)_30%,var(--background))]",
        "dark:[html[data-theme-id=dispatch-chat]_&]:[--chat-composer-highlight:color-mix(in_srgb,#432d48_12%,transparent)] dark:[html[data-theme-id=dispatch-chat]_&]:[--chat-composer-outline:#241e28]",
        ...
        contextStrip && [
          // The strip's outline is a pseudo-element, so it adds no layout border.
          "[--chat-composer-context-extension:calc(1.75rem+2*var(--chat-composer-context-inset))] sm:[--chat-composer-context-extension:calc(1.5rem+2*var(--chat-composer-context-inset))]",
...
function ContextStrip({ className, ...props }: ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "group/composer-context relative isolate mx-auto -mt-4 flex w-[calc(100%-2*var(--chat-composer-drawer-inset))] items-center gap-2 overflow-x-clip overflow-y-visible px-(--chat-composer-context-inset) pt-[calc(1rem+var(--chat-composer-context-inset))] pb-(--chat-composer-context-inset)",
