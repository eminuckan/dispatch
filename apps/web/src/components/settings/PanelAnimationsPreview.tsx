...
export function PanelAnimationsPreview({ durationMs }: { durationMs: number }) {
  ...
  return (
    <button
      ...
      className="flex h-10 w-full cursor-pointer overflow-hidden rounded-lg border border-border bg-background p-[calc(var(--radius-lg)-var(--radius-md)-1px)] shadow-xs/5 outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:ring-offset-background"
