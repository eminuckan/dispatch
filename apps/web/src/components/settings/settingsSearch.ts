...
export const SETTINGS_SEARCH_ITEMS = [
  ...
  },
  {
    ...
    title: "About",
    to: "/settings/general",
    searchTerms: ["Dispatch application installed version"],
  },
  {
    id: "desktop-updates",
    ...
    to: "/settings/general",
    targetId: "about",
    searchTerms: ["check download install restart update track channel stable preview release"],
    desktopOnly: true,
  },
  {
    id: "diagnostics",
  ...
  },
  {
    ...
    targetId: "routing-general",
    searchTerms: ["flow", "standard", "auto", "automatic", "team", "lead", "workers", "composer"],
  ...
  },
  {
    ...
    title: "Smart Routing",
    to: "/settings/orchestration",
    targetId: "routing-recommendations",
    searchTerms: ["flow", "auto", "hosted", "connect", "models", "recommendations"],
    environmentOnly: true,
  },
  {
    id: "routing-models",
    ...
    searchTerms: ["lead", "worker", "models", "team"],
    environmentOnly: true,
  },
  {
    ...
    to: "/settings/orchestration",
    targetId: "routing-provider-limits",
    searchTerms: ["ask", "continue", "another provider", "pause", "usage limit"],
    environmentOnly: true,
  },
