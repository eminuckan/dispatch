import type { DesktopSshEnvironmentTarget, EnvironmentMachineKind } from "@dispatch/contracts";
 ...
 * Legacy, SSH, WSL, and plain remote links are told apart without a legend.
 */
export function environmentTransportLabel(environment: EnvironmentPresentation): string {
  ...
  if (environment.relayManaged) return "Legacy connection";
