...
const FILE_EXPLORER_STORAGE_KEY = "dispatch.fileExplorerOpen";
const RENDER_MARKDOWN_STORAGE_KEY = "dispatch.renderMarkdown";
const RENDER_BROWSER_FILE_STORAGE_KEY = "dispatch.renderBrowserFile";
const RENDER_TABLE_STORAGE_KEY = "dispatch.renderTable";
