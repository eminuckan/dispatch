import { withDeviceHubQuery } from "@dispatch/client-runtime/state/deviceHubAccess";
import type { DeviceHubAccess } from "@dispatch/client-runtime/state/deviceHubAccess";
