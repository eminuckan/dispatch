import { EnvironmentId, MessageId, ThreadId, type AssistantCitation } from "@dispatch/contracts";
import { serializeAssistantCitation } from "@dispatch/shared/assistantCitations";
