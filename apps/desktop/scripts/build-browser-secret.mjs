...
// oxlint-disable-next-line dispatch/no-global-process-runtime -- The native compiler targets the actual host; this script has no Effect runtime.
const hostArch = process.arch;
// oxlint-disable-next-line dispatch/no-global-process-runtime -- Native compilation only runs on the actual Linux host.
...
if (hostPlatform === "linux") {
  ...
  const output =
    values.output ?? NodePath.resolve(root, "build", values.arch, "dispatch-browser-secret");
