import { EnvironmentId, type PersistedSavedEnvironmentRecord } from "@dispatch/contracts";
import { fromLenientJson } from "@dispatch/shared/schemaJson";
...
>()("@dispatch/desktop/settings/DesktopSavedEnvironments") {}
