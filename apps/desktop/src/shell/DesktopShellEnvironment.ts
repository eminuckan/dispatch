...
>()("@dispatch/desktop/shell/DesktopShellEnvironment") {}
...
const startMarker = (name: string) => `__DISPATCH_ENV_${name}_START__`;
const endMarker = (name: string) => `__DISPATCH_ENV_${name}_END__`;
