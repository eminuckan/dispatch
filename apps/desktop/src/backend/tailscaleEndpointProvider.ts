import { createAdvertisedEndpoint } from "@dispatch/shared/advertisedEndpoint";
import type { AdvertisedEndpoint, AdvertisedEndpointProvider } from "@dispatch/contracts";
import {
...
export { parseTailscaleMagicDnsName } from "@dispatch/tailscale";
