import { PRIMARY_LOCAL_ENVIRONMENT_ID } from "@dispatch/contracts";
import {
  makeLocalFileTracer,
  makeTraceSink,
  otlpSerializationLayer,
} from "@dispatch/shared/observability";
import {
...
>()("@dispatch/desktop/app/DesktopObservability/DesktopBackendOutputLogFactory") {}
