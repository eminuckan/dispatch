...
export class DesktopDevelopmentBackendPortRequiredError extends Schema.TaggedError<DesktopDevelopmentBackendPortRequiredError>()(
  ...
  override get message(): string {
    return "DISPATCH_PORT is required in desktop development.";
  }
}
...
const startup = Effect.gen(function* () {
  ...
  const linuxIntegration = yield* DesktopLinuxIntegration.DesktopLinuxIntegration;
  ...
  yield* linuxIntegration.register;
