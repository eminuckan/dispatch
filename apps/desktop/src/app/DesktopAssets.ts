...
>()("@dispatch/desktop/app/DesktopAssets") {}
...
function resolveSourceTreeIconPath(
  ...
  const fileName = ext === "ico" ? "icon.ico" : "icon-1024.png";
  return environment.path.join(environment.rootDir, "assets", "dispatch", fileName);
}
