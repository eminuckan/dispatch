 ...
 * into a Dispatch browser profile's Electron partition.
 *
...
import { BrowserImportFailureReason } from "@dispatch/contracts";
...
import { HostProcessExecutablePath, HostProcessPlatform } from "@dispatch/shared/hostProcess";
...
>()("@dispatch/desktop/preview/BrowserImport/BrowserImport") {}
