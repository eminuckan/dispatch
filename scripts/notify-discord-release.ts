  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Dispatch prerelease is available for nightly testers."
          : "A new Dispatch latest release is available.",
...
).pipe(Command.withDescription("Post a Dispatch release announcement to Discord."));
