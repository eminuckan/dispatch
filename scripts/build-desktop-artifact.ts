...
import { fromYaml } from "@dispatch/shared/schemaYaml";
...
const buildDesktopArtifact = Effect.fn("buildDesktopArtifact")(function* (
  ...
  yield* runCommand(
    ...
    {
      label: `vp exec --filter @dispatch/desktop -- electron-builder --projectDir ${stageAppDir} ${platformConfig.cliFlag} --${options.arch} --publish never`,
      verbose: options.verbose,
    },
  );
