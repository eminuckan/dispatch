...
Item {
    ...
    // A cached, bounded PNG is shared by each output. Nothing repaints while waiting for Dispatch.
    Image {
        id: snapshot
        visible: false
    ...
    DBusCall {
        id: next
        service: root.bus
        path: "/com/eminuckan/dispatch/KdeCapture/Feedback"
        dbusInterface: "com.eminuckan.dispatch.KdeCapture.Feedback"
        method: "Next"
