import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@dispatch/contracts";
import { resolveRemotePairingTarget } from "@dispatch/shared/remote";
...
>()("@dispatch/client-runtime/connection/onboarding/ConnectionOnboarding") {}
