 ...
 * machine into a Dispatch browser profile.
 *
...
export const BrowserImportInput = Schema.Struct({
  ...
  /** Dispatch profile the cookies are written into. */
...
const BROWSER_IMPORT_UNAVAILABLE_COPY: Readonly<Record<BrowserImportUnavailableReason, string>> = {
  ...
  needsFullDiskAccess:
    "Give Dispatch Full Disk Access in System Settings → Privacy & Security, then retry.",
