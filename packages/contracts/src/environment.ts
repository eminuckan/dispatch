...
/** What update path a client should offer for a server: one of the RPC
    ...
    version belongs to the Dispatch desktop app supervising it — updating the
...
export const ExecutionEnvironmentCapabilities = Schema.Struct({
  ...
  /** Server persists and applies branch prefixes; absent means unsupported. */
  branchPrefixSettings: Schema.optionalKey(Schema.Boolean),
